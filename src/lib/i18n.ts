...
const strings = {
  ...
  cefrA1: {
    ko: "입문 — 기본 인사, 자기소개 수준", en: "Beginner — Basic greetings and self-introduction",
    es: "Principiante — Saludos básicos y presentación", fr: "Débutant — Salutations et présentation de base",
    zh: "入门 — 基本问候和自我介绍", ja: "入門 — 基本的な挨拶と自己紹介",
    de: "Anfänger — Grundlegende Begrüßung und Vorstellung", pt: "Iniciante — Saudações básicas e apresentação",
    it: "Principiante — Saluti di base e presentazione", ru: "Начальный — Базовые приветствия и представление",
    ar: "مبتدئ — تحيات أساسية وتقديم النفس", hi: "शुरुआती — बुनियादी अभिवादन और आत्म-परिचय",
    tr: "Başlangıç — Temel selamlaşma ve tanışma", id: "Pemula — Sapaan dasar dan perkenalan diri",
    vi: "Sơ cấp — Chào hỏi cơ bản và tự giới thiệu", pl: "Początkujący — Podstawowe powitania i przedstawienie się",
  },
  cefrA2: {
    ko: "초급 — 일상적인 표현, 간단한 대화", en: "Elementary — Everyday expressions and simple conversations",
    es: "Elemental — Expresiones cotidianas y conversaciones simples", fr: "Élémentaire — Expressions quotidiennes et conversations simples",
    zh: "初级 — 日常表达和简单对话", ja: "初級 — 日常表現と簡単な会話",
    de: "Grundstufe — Alltagsausdrücke und einfache Gespräche", pt: "Elementar — Expressões cotidianas e conversas simples",
    it: "Elementare — Espressioni quotidiane e conversazioni semplici", ru: "Элементарный — Повседневные выражения и простые беседы",
    ar: "أساسي — تعبيرات يومية ومحادثات بسيطة", hi: "प्रारंभिक — रोज़मर्रा की अभिव्यक्ति और सरल बातचीत",
    tr: "Temel — Günlük ifadeler ve basit konuşmalar", id: "Dasar — Ungkapan sehari-hari dan percakapan sederhana",
    vi: "Sơ cấp 2 — Diễn đạt hàng ngày và hội thoại đơn giản", pl: "Podstawowy — Codzienne wyrażenia i proste rozmowy",
  },
  cefrB1: {
    ko: "중급 — 여행, 관심사에 대해 대화 가능", en: "Intermediate — Can discuss travel, interests, and experiences",
    es: "Intermedio — Puede hablar de viajes, intereses y experiencias", fr: "Intermédiaire — Peut discuter de voyages, d'intérêts et d'expériences",
    zh: "中级 — 能讨论旅行、兴趣和经历", ja: "中級 — 旅行、趣味、経験について会話可能",
    de: "Mittelstufe — Kann über Reisen, Interessen und Erfahrungen sprechen", pt: "Intermediário — Pode discutir viagens, interesses e experiências",
    it: "Intermedio — Può discutere di viaggi, interessi ed esperienze", ru: "Средний — Может обсуждать путешествия, интересы и опыт",
    ar: "متوسط — يمكنه مناقشة السفر والاهتمامات والتجارب", hi: "मध्यवर्ती — यात्रा, रुचियों और अनुभवों पर बात कर सकता है",
    tr: "Orta — Seyahat, ilgi alanları ve deneyimler hakkında konuşabilir", id: "Menengah — Dapat membahas perjalanan, minat, dan pengalaman",
    vi: "Trung cấp — Có thể thảo luận về du lịch, sở thích và trải nghiệm", pl: "Średniozaawansowany — Może rozmawiać o podróżach, zainteresowaniach i doświadczeniach",
  },
  cefrB2: {
    ko: "중상급 — 복잡한 주제도 유창하게 토론", en: "Upper Intermediate — Can discuss complex topics fluently",
    es: "Intermedio alto — Puede discutir temas complejos con fluidez", fr: "Intermédiaire supérieur — Peut discuter couramment de sujets complexes",
    zh: "中高级 — 能流利讨论复杂话题", ja: "中上級 — 複雑なトピックを流暢に議論可能",
    de: "Obere Mittelstufe — Kann komplexe Themen fließend diskutieren", pt: "Intermediário superior — Pode discutir temas complexos com fluência",
    it: "Intermedio superiore — Può discutere fluentemente argomenti complessi", ru: "Выше среднего — Может свободно обсуждать сложные темы",
    ar: "فوق المتوسط — يمكنه مناقشة مواضيع معقدة بطلاقة", hi: "उच्च मध्यवर्ती — जटिल विषयों पर धाराप्रवाह चर्चा कर सकता है",
    tr: "Üst orta — Karmaşık konuları akıcı bir şekilde tartışabilir", id: "Menengah atas — Dapat membahas topik kompleks dengan lancar",
    vi: "Trung cấp cao — Có thể thảo luận lưu loát các chủ đề phức tạp", pl: "Wyższy średniozaawansowany — Może płynnie dyskutować o złożonych tematach",
  },
  cefrC1: {
    ko: "고급 — 학술적, 전문적 주제까지 자유롭게", en: "Advanced — Can handle academic and professional topics freely",
    es: "Avanzado — Puede manejar temas académicos y profesionales libremente", fr: "Avancé — Peut traiter librement des sujets académiques et professionnels",
    zh: "高级 — 能自如应对学术和专业话题", ja: "上級 — 学術的・専門的なトピックも自由に対応可能",
    de: "Fortgeschritten — Kann akademische und professionelle Themen frei behandeln", pt: "Avançado — Pode lidar livremente com temas acadêmicos e profissionais",
    it: "Avanzato — Può gestire liberamente argomenti accademici e professionali", ru: "Продвинутый — Свободно владеет академическими и профессиональными темами",
    ar: "متقدم — يمكنه التعامل مع المواضيع الأكاديمية والمهنية بحرية", hi: "उन्नत — शैक्षणिक और पेशेवर विषयों को स्वतंत्र रूप से संभाल सकता है",
    tr: "İleri — Akademik ve profesyonel konuları özgürce ele alabilir", id: "Lanjutan — Dapat menangani topik akademik dan profesional dengan bebas",
    vi: "Cao cấp — Có thể xử lý tự do các chủ đề học thuật và chuyên môn", pl: "Zaawansowany — Może swobodnie poruszać tematy akademickie i zawodowe",
  },
  cefrC2: {
    ko: "최고급 — 원어민에 가까운 수준", en: "Mastery — Near-native speaker level",
    es: "Maestría — Nivel casi nativo", fr: "Maîtrise — Niveau quasi natif",
    zh: "精通 — 接近母语者水平", ja: "最上級 — ネイティブに近いレベル",
    de: "Meisterschaft — Fast muttersprachliches Niveau", pt: "Maestria — Nível quase nativo",
    it: "Padronanza — Livello quasi madrelingua", ru: "Совершенство — Уровень, близкий к носителю языка",
    ar: "إتقان — مستوى قريب من الناطق الأصلي", hi: "दक्षता — मूल वक्ता के करीब का स्तर",
    tr: "Ustalık — Ana dili seviyesine yakın", id: "Mahir — Mendekati tingkat penutur asli",
    vi: "Thành thạo — Gần như người bản ngữ", pl: "Biegłość — Poziom zbliżony do native speakera",
  },
  cefrAssessed: {
  ...
  dictionary: {
    ko: "내 사전", en: "My Dictionary", es: "Mi Diccionario", fr: "Mon Dictionnaire",
    zh: "我的词典", ja: "マイ辞書", de: "Mein Wörterbuch", pt: "Meu Dicionário",
    it: "Il mio Dizionario", ru: "Мой словарь", ar: "قاموسي", hi: "मेरा शब्दकोश",
    tr: "Sözlüğüm", id: "Kamus Saya", vi: "Từ điển của tôi", pl: "Mój słownik",
  },
  addToDictionary: {
    ko: "사전에 추가", en: "Add to Dictionary", es: "Agregar al diccionario", fr: "Ajouter au dictionnaire",
    zh: "添加到词典", ja: "辞書に追加", de: "Zum Wörterbuch hinzufügen", pt: "Adicionar ao dicionário",
    it: "Aggiungi al dizionario", ru: "Добавить в словарь", ar: "أضف إلى القاموس", hi: "शब्दकोश में जोड़ें",
    tr: "Sözlüğe ekle", id: "Tambah ke kamus", vi: "Thêm vào từ điển", pl: "Dodaj do słownika",
  },
  savedToDictionary: {
    ko: "저장됨", en: "Saved", es: "Guardado", fr: "Enregistré",
    zh: "已保存", ja: "保存済み", de: "Gespeichert", pt: "Salvo",
    it: "Salvato", ru: "Сохранено", ar: "تم الحفظ", hi: "सहेजा गया",
    tr: "Kaydedildi", id: "Tersimpan", vi: "Đã lưu", pl: "Zapisano",
  },
  emptyDictionary: {
    ko: "저장된 단어가 없습니다", en: "No saved words yet", es: "Aún no hay palabras guardadas", fr: "Pas encore de mots enregistrés",
    zh: "还没有保存的单词", ja: "保存された単語はありません", de: "Noch keine gespeicherten Wörter", pt: "Nenhuma palavra salva ainda",
    it: "Nessuna parola salvata", ru: "Сохранённых слов пока нет", ar: "لا توجد كلمات محفوظة بعد", hi: "अभी तक कोई शब्द सहेजा नहीं गया",
    tr: "Henüz kaydedilmiş kelime yok", id: "Belum ada kata yang disimpan", vi: "Chưa có từ nào được lưu", pl: "Brak zapisanych słów",
  },
  allLanguages: {
    ko: "전체", en: "All", es: "Todos", fr: "Tous",
    zh: "全部", ja: "すべて", de: "Alle", pt: "Todos",
